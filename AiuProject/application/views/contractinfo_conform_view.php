        ...
        <div class="container" style="font-size: 12px;">
            ...
            <div class="clearfix" style="border: 1px solid #e5e5e5;width: 824px; margin-left: auto; margin-right: auto;">
                <div style="border: 1px solid #e5e5e5; padding-left: 10px; padding-top: 10px; width: 813px;">
                    ...
                    <table>
                        <tr><td width="120">契約手段</td><td><textarea class="span8" name="contract_way" rows="5" wrap="hard"></textarea></td></tr>
                        <tr><td>契約場所</td><td><textarea class="span8" name="contact_place" cols="120" rows="5" wrap="hard"></textarea></td></tr>
                        <tr><td>連絡時間帯</td><td><textarea class="span8" name="contact_time" cols="120" rows="5" wrap="hard"></textarea></td></tr>
                        <tr><td>人柄</td><td><textarea class="span8" name="personality" cols="120" rows="5" wrap="hard"></textarea></td></tr>
                        <tr><td>家族構成</td><td><textarea class="span8" name="family_structure" cols="120" rows="5" wrap="hard"></textarea></td></tr>
                        <tr><td>趣味</td><td><textarea class="span8" name="taste" cols="120" rows="5" wrap="hard"></textarea></td></tr>
                        <tr><td>状況</td><td><textarea class="span8" name="state" cols="120" rows="5" wrap="hard"></textarea></td></tr>
                    </table>
                </div>
            </div>
